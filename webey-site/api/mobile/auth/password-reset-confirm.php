<?php
// api/mobile/auth/password-reset-confirm.php  (Customer)
...
try {
    $stmt = $pdo->prepare(
        "SELECT u.id FROM users u LEFT JOIN customers c ON c.user_id = u.id
    ...
    error_log('[mobile/auth/password-reset-confirm] ' . $e->getMessage());
